...
param Availability string = 'AvailabilityDefaultValue'
param AvailabilitySetNamePrefix string = 'AvailabilitySetNamePrefixDefaultValue'
param AvailabilityZones array = [ '1' ]
param DiskEncryptionSetResourceId string = 'DiskEncryptionSetResourceIdDefaultValue'
param DomainServices string = 'DomainServicesDefaultValue'
param HostPoolResourceId string = 'HostPoolResourceIdDefaultValue'
param KeyVaultResourceId string = 'KeyVaultResourceIdDefaultValue'
param SessionHostCount int = 1
param SessionHostIndex int = 0
param SessionHostLocation string = 'SessionHostLocationDefaultValue'
param SessionHostOuPath string = 'SessionHostOuPathDefaultValue'
param SessionHostResourceGroupName string = 'SessionHostResourceGroupNameDefaultValue'
param SubnetResourceId string = 'SubnetResourceIdDefaultValue'
